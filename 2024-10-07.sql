...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Out-2024 às 23:16
...
(1, '2024-08-22', '2024-08-25', 1, 4),
(2, '2024-08-24', '2024-08-26', 7, 1),
(3, '2024-08-30', '2024-09-02', 3, 5),
(4, '2024-09-10', '2024-09-15', 4, 1),
(5, '2024-09-11', '2024-09-18', 2, 3),
(6, '2024-09-14', '2024-09-16', 7, 5),
(7, '2024-09-20', '2024-09-22', 5, 2),
(8, '2024-09-25', '2024-09-27', 6, 4),
(9, '2024-10-01', '2024-10-03', 2, 2),
(10, '2024-10-02', '2024-10-03', 3, 5);
...
--
ALTER TABLE `leitores`
  MODIFY `CodLeitor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
